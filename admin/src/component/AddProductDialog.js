...
import {
    ...
    Select, MenuItem, InputLabel, FormControl, Box, Button,
            ...
            <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth sx={{ width: isMobile ? "auto":"450px", mx: "auto" }}>
                ...
                <DialogContent dividers>
                    <Box sx={{ display: "grid", gap: 1.5 }}>
                        <TextField label="Name" name="title" value={newProduct.title} onChange={handleInputChange} fullWidth error={!!formErrors.title} helperText={formErrors.title} />
                        ...
                        <Box>
                            ...
                            {newProduct.imagePreview && (
                                <Box mt={2} display="flex" justifyContent="center">
                                    <img src={newProduct.imagePreview} alt="Product Preview" style={{ width: "120px", height: "120px", objectFit: "cover", borderRadius: "8px", border: "1px solid #ddd" }} />
                                </Box>
                                )}
                        </Box>
                    </Box>
                ...
                <DialogActions>
                    <Button onClick={handleSubmit} variant="contained" color="primary">{loading ? <CircularProgress size={22} /> : product ? "Update" : "Add"}</Button>
                </DialogActions>
            </Dialog>
